...
//                                "\nCREATE TABLE IF NOT EXISTS dbo_gds_reservas ( cpf text, cdevento integer, nome text, dtevento datetime, FOREIGN KEY (cdevento) REFERENCES dbo_gds_eventos(cdevento) ); ");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS dbo_gds_reservas ( idreserva integer primary key, cpf text, cdevento integer, nome text, dtevento text, compareceu text, FOREIGN KEY (cdevento) REFERENCES dbo_gds_eventos(cdevento) ); ");
